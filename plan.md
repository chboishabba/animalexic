...
- The next surface-building layer is now in place: `scripts/surfel_cluster.py` groups the trusted promoted surfels into local PCA-based connected components, producing an initial object-centric structure view without changing the guarded accumulation policy.
